...
button_equal = Button(root,text="=",padx=160,pady=20,command=button_equal)
button_clear = Button(root,text="Clear",padx=150,pady=20,command=button_clear)
